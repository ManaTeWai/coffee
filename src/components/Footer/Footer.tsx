				...
				<div className={styles.footer_menu}>
					...
					<div>
						...
						<div className={styles.social}>
							<Link href="https://vk.com/manatewai" className={styles.socials_item}>
								<svg xmlns="http://www.w3.org/2000/svg" className={styles.socials_item_icon}><use href="./img/social.svg#i-vk"></use></svg>
							</Link>
							<Link href="https://t.me/manatewai" className={styles.socials_item}>
								<svg xmlns="http://www.w3.org/2000/svg" className={styles.socials_item_icon}><use href="./img/social.svg#i-tg"></use></svg>
							</Link>
						</div>
					</div>
				</div>
