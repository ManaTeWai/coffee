		...
		<div className={styles.page_wrapper}>
			...
			<div className={styles.promotions}>
				<div className={styles.promotion_card}>
					<Image width={300} height={300} src="/img/promotion1.png" alt="Акция 1"/>
				...
				<div className={styles.promotion_card}>
					<Image width={300} height={300} src="/img/promotion2.png" alt="Акция 2"/>
				...
				<div className={styles.promotion_card}>
					<Image width={300} height={300} src="/img/promotion3.png" alt="Акция 3"/>
